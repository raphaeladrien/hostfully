...
public class CreateBlock {
    ...
    public Block execute(final CreateBlockCommand createBlockCommand) {
        ...
        try {
            return BlockMapper.toDomain(blockRepository.save(BlockMapper.toEntity(block, propertyEntity)));
        } catch (Exception ex) {
    ...
    public record CreateBlockCommand(String property, String reason, LocalDate startDate, LocalDate endDate) {}
}
